...
contextBridge.exposeInMainWorld('api', {
  ...
  onNewImage: (callback: (payload: { dataUrl: string; settings: RemoteSettings; fileName: string }) => void) => {
    const wrapper = (_event: IpcRendererEvent, payload: any) => callback(payload);
