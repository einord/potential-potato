...
export class DebUpdater {
    ...
    async checkForUpdates() {
        try {
            ...
            if (this.isNewerVersion(latestVersion, this.currentVersion)) {
                ...
                const debAsset = release.assets.find(asset => asset.name.endsWith('.deb') && asset.name.includes(arch));
                if (debAsset) {
    ...
    async downloadAndInstallUpdate(asset) {
        try {
...
//# sourceMappingURL=deb-updater.js.map