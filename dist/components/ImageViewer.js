...
export class ImageViewer extends HTMLElement {
    ...
    currentData = 'https://wallpapercave.com/wp/9gAmpUH.jpg';
    isTransitioning = false;
    activeImageIndex = 0; // 0 eller 1 för att växla mellan bildlager
    shadow;
    wrapper;
    imageLayer1;
    imageLayer2;
    ...
    applyPassepartoutSettings(settings, imageElement) {
